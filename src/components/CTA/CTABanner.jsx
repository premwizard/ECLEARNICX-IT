    ...
    <section className="py-20 relative overflow-hidden bg-gradient-to-r from-secondaryGradient to-primary">
      ...
      <div className="w-full px-6 md:px-12 relative z-10 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-3/4 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 style={{ fontFamily: '"Sora", sans-serif', fontSize: 'clamp(22px, 3vw, 36px)', fontWeight: 700 }} className="text-white mb-6">We're Ready Develop Your Site!</h2>
            <div style={{ fontFamily: '"Sora", sans-serif', fontSize: '15px' }} className="flex flex-wrap gap-6 text-white font-medium">
          ...
          <button style={{ fontFamily: '"Sora", sans-serif', fontSize: '13px', fontWeight: 700, letterSpacing: '2px' }} className="bg-white text-primary px-8 py-4 uppercase hover:bg-darkBg hover:text-white transition-colors whitespace-nowrap">
            Learn More
          </button>
        </div>
      </div>

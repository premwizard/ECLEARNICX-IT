...
export default function BottomCTA() {
  return (
    <section className="section-light py-32" id="contact">
      {/* Background Lighting */}
      ...
      <div className="w-full px-6 md:px-12 relative z-10 flex flex-col items-center text-center">
        ...
        <h2 style={{ fontFamily: '"Manrope", sans-serif', fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: 700 }} className="text-heading leading-[1.3] uppercase tracking-tighter mb-10 max-w-4xl py-4 overflow-visible">
